...
export const PolishLanguage: ICommonLanugageInterface = {
  ...
  mainScreen: {
    ...
    siteDescription: "Miejscu, w którym wyjątkowy rzemieślnik tworzy wykwintne, ręcznie robione meble z niezrównaną precyzją i dbałością o szczegóły",
    attributes: {
  ...
  presentationScreen: {
    uniqueFurniture: "Unikalne meble",
    description:
